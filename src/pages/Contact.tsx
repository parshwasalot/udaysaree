        ...
        <main className="pt-20">
          ...
          <section className="py-20 bg-gradient-to-b from-maroon-dark to-primary">
            <div className="container mx-auto px-4 text-center">
              <p className="text-gold font-medium mb-4 tracking-wider uppercase text-sm">Get in Touch</p>
          ...
          <section className="py-20">
            <div className="container mx-auto px-4">
              <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div className="p-6 bg-card rounded-lg border border-border shadow-card">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <a href="mailto:udaysareeshowroom@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                {/* Map */}
                <div className="rounded-lg overflow-hidden shadow-elegant h-[500px] lg:h-auto min-h-[500px]">
                  <iframe
