    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 pt-20">
        <div className="max-w-2xl">
          ...
          {/* Heading */}
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-ivory leading-tight mb-6 animate-slide-up">
            Timeless Sarees for{" "}
            <span className="text-gradient-gold">Every Occasion</span>
          </h1>

          {/* Subheading */}
          <p className="text-lg md:text-xl text-ivory/80 mb-8 leading-relaxed animate-slide-up" style={{ animationDelay: "0.1s" }}>
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap gap-8 mt-12 pt-8 border-t border-ivory/20 animate-slide-up" style={{ animationDelay: "0.3s" }}>
            <div>
              <p className="font-serif text-3xl font-bold text-gold">40+</p>
              <p className="text-ivory/70 text-sm">Years of Trust</p>
            </div>
            <div>
              <p className="font-serif text-3xl font-bold text-gold">10,000+</p>
              <p className="text-ivory/70 text-sm">Happy Customers</p>
            </div>
            <div>
              <p className="font-serif text-3xl font-bold text-gold">5000+</p>
              <p className="text-ivory/70 text-sm">Saree Varieties</p>
            </div>
          </div>
        </div>
      </div>
